#!/bin/bash
# FFMPEG AUTO INSTALLER FOR UNIX BY Shekhar Suman
...
echo "Done......."
echo "3) Downloading ffmpeg-php package modded by Shekhar Suman."
if rpm -q php54; then
wget https://raw.githubusercontent.com/ShekharSumanPro/FFMPEGAutoInstaller/master/ffmpeg-php-0.6-php54.zip
unzip ffmpeg-php-0.6-php54.zip
else
wget https://raw.githubusercontent.com/ShekharSumanPro/FFMPEGAutoInstaller/master/ffmpeg-php-0.6.zip
...
echo "Done........"
echo "FFMpeg installation completed.. Thanks for using Shekhar Suman FFMpeg Auto Installer. :)"
 break;;
        [Nn]* ) exit;;
